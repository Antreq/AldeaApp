...
@section('content')
	<div class="card">
            <div class="card-header">
              ...
              <button class="btn btn-primary float-right" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus-circle"> </i> Crear publicación</button>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <tbody>
                	@foreach ($posts as $post)
                		<tr>
                			...
                			<td>
                        <a href="{{route('post.show', $post) }}" class="btn btn-xs btn-light" target='_blank'>
                          <i class="fa fa-eye"></i>
                        </a>
                        ...
                        <form method="POST" action="{{route('admin.posts.destroy', $post) }}" style="display:inline">
                          ...
                          <button href="#" class="btn btn-xs btn-danger" onclick="return confirm('¿Estás seguro de querer eliminar esta publicación?')">
